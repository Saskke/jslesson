...
// git push -u origin main  -- этой командой мы отправляем файлы на github (почему то с -u возникает ошибка)



// далее для добавления изменений пишем сначала:
// 1) git add -A
// 2) git commit -a -m"коммент"
// 3) git push origin master



// СЛЕДУЮЩИЙ УРОК. КАК РАБОТАТЬ С GitHub с разных компьютеров. gitignore и Git Kraken

// cd ..   - выход из папки в терминале

// git clone https://github.com/Saskke/jslesson.git progect   -- копир. с гита.  ссылку берем с гита, progect это название папки которая будет создана и все файлы отправятся туда

// git pull догрузит изменения в проект из GitHub


// .gitignore скрипт который позваляет не заливать все файлы на GitHub

// программа git kraken позваляет удобно смотреть комментарии и вставлять их